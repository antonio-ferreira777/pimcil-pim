...
class CrmDocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = CrmDocument::with(['customer', 'status'])->select(sprintf('%s.*', (new CrmDocument)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'customer', 'document_file', 'status']);
    ...
    public function create()
    {
        ...
        return view('admin.crmDocuments.create', compact('customers', 'statuses'));
    }
    ...
    public function edit(CrmDocument $crmDocument)
    {
        ...
        $crmDocument->load('customer', 'status');

        return view('admin.crmDocuments.edit', compact('crmDocument', 'customers', 'statuses'));
    }
