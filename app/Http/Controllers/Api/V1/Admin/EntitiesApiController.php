...
class EntitiesApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('entity_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new EntityResource(Entity::with(['taxonomy', 'type', 'team', 'language'])->get());
    }
    ...
    public function show(Entity $entity)
    {
        ...
        return new EntityResource($entity->load(['taxonomy', 'type', 'team', 'language']));
    }
