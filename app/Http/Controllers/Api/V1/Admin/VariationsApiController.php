...
class VariationsApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('variation_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new VariationResource(Variation::with(['entity', 'field', 'master_entity'])->get());
    }
    ...
    public function show(Variation $variation)
    {
        ...
        return new VariationResource($variation->load(['entity', 'field', 'master_entity']));
    }
