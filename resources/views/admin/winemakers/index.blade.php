...
@section('content')
@can('winemaker_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.winemakers.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.winemaker.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.winemaker.title_singular') }} {{ trans('global.list') }}
    </div>
