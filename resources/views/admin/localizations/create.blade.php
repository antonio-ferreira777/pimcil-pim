...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.localization.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.localizations.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="data_table">{{ trans('cruds.localization.fields.data_table') }}</label>
                <input class="form-control {{ $errors->has('data_table') ? 'is-invalid' : '' }}" type="text" name="data_table" id="data_table" value="{{ old('data_table', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_value') ? 'is-invalid' : '' }}" type="text" name="data_value" id="data_value" value="{{ old('data_value', '') }}" required>
