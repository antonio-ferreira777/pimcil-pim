    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fields.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default') ? 'is-invalid' : '' }}" type="text" name="default" id="default" value="{{ old('default', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('nullable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="nullable" id="nullable" value="1" {{ old('nullable', 0) == 1 || old('nullable') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('form_blocs') ? 'is-invalid' : '' }}" name="form_blocs[]" id="form_blocs" multiple required>
                    @foreach($form_blocs as $id => $form_bloc)
                        <option value="{{ $id }}" {{ in_array($id, old('form_blocs', [])) ? 'selected' : '' }}>{{ $form_bloc }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('taxonomies') ? 'is-invalid' : '' }}" name="taxonomies[]" id="taxonomies" multiple>
                    @foreach($taxonomies as $id => $taxonomy)
                        <option value="{{ $id }}" {{ in_array($id, old('taxonomies', [])) ? 'selected' : '' }}>{{ $taxonomy }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('taxonomy_transversality') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="taxonomy_transversality" id="taxonomy_transversality" value="1" {{ old('taxonomy_transversality', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('channels_transversality') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="channels_transversality" id="channels_transversality" value="1" {{ old('channels_transversality', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('language_transversality') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="language_transversality" id="language_transversality" value="1" {{ old('language_transversality', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('countries_transversality') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="countries_transversality" id="countries_transversality" value="1" {{ old('countries_transversality', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('entities_transversality') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="entities_transversality" id="entities_transversality" value="1" {{ old('entities_transversality', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_source') ? 'is-invalid' : '' }}" type="text" name="data_source" id="data_source" value="{{ old('data_source', '') }}">
