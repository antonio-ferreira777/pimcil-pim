        ...
        <form method="POST" action="{{ route("admin.fields.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('channels_transversality') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="channels_transversality" id="channels_transversality" value="1" required {{ old('channels_transversality', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('language_transversality') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="language_transversality" id="language_transversality" value="1" required {{ old('language_transversality', 0) == 1 ? 'checked' : '' }}>
